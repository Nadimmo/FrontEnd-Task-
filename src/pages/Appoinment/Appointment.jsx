...
function Appointment() {
  ...
  return (
    <div className="min-h-screen text-white bg-gradient-to-br from-[#0a1438] via-[#0d1b4c] to-[#050b24]">
      <DHeader text={"Appointment"}></DHeader>
      <div className="mt-6 p-2 lg:pl-6">
        {/* Stats */}
        ...
        {/* Booking Link */}
        <div className="bg-[#0b1538] border border-white/10 rounded-xl p-5 mb-8 lg:h-[140px] ">
          <h3 className="mb-4 lg:text-left text-center">Booking Link</h3>
